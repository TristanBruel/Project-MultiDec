...
plt.loglog(KAG_psd[:,0],KAG_psd[:,5],color=colors[5],label='KAGRA design')
plt.loglog(ADV_psd[:,0],ADV_psd[:,6],color=colors[4],label='Virgo design')
plt.loglog(AL_psd[:,0],AL_psd[:,6],color=colors[3],label='aLIGO design')
plt.loglog(ET_D_psd[:,0],ET_D_psd[:,3],color=colors[0],label='ET')
plt.loglog(CE1_psd[:,0],CE1_psd[:,1],color=colors[1],label='CE')
#plt.loglog(CE2_psd[:,0],CE2_psd[:,1],color=colors[2],label='CE stage2')
