...
plt.xlim(-180,180)
xticks = [str(n)+'°W' for n in range(180,0,-60)]
xticks += ['0°']
xticks += [str(n)+'°E' for n in range(30,210,60)]
lon_axis = np.arange(-180,181,60)
...
fig_name = 'detectors_map.png';
plt.savefig(fig_name)
fig_name = 'detectors_map.pdf';
plt.savefig(fig_name)
